...
public class SelListAdapter extends BaseExpandableListAdapter {
    private final FragmentActivity mContext;
    private final List<DistriButionBean.DistriButionsBean> data;
    private OnCheckedClickLitener onCheckedClickLitener;
    public SelMultipleAdapter mAdapter;

    public SelListAdapter(FragmentActivity activity, List<DistriButionBean.DistriButionsBean> distribution) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            List<DistriButionBean.DistriButionsBean.DistriBean> distri = distriButionsBean.getDistri();
            mAdapter = new SelMultipleAdapter(mContext, distri);
