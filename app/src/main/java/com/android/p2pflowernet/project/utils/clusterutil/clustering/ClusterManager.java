...
import com.android.p2pflowernet.project.utils.clusterutil.clustering.algo.Algorithm;
import com.android.p2pflowernet.project.utils.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.android.p2pflowernet.project.utils.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import com.android.p2pflowernet.project.utils.clusterutil.clustering.view.ClusterRenderer;
import com.android.p2pflowernet.project.utils.clusterutil.clustering.view.DefaultClusterRenderer;
...
/**
 * Groups many items on a activity_course_order_layout based on zoom level.
 * <p/>
 * ClusterManager should be added to the activity_course_order_layout
 * <li>
 */
public class ClusterManager<T extends ClusterItem> implements
    ...
    public void onMapStatusChange(MapStatus mapStatus) {
        ...
        // Don't re-compute clusters if the activity_course_order_layout has just been panned/tilted/rotated.
     ...
     * the ClusterManager must be added as a click listener to the activity_course_order_layout.
     */
    ...
    /**
     * Sets a callback that's invoked when a Cluster is tapped. Note: For this listener to function,
     * the ClusterManager must be added as a info window click listener to the activity_course_order_layout.
     */
     ...
     * listener to function, the ClusterManager must be added as a click listener to the activity_course_order_layout.
     */
     ...
     * listener to function, the ClusterManager must be added as a info window click listener to the activity_course_order_layout.
     */
