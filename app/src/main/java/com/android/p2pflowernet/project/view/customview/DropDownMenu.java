...
public class DropDownMenu extends LinearLayout {
    ...
    public static int current_tab_position = -1;
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int menuBackgroundColor = 00000000;
...
//        maskView.setBackgroundColor(maskColor);
    ...
    private void addTab(@NonNull final List<String> tabTexts, int i) {
        ...
        LayoutParams layoutParams1 = new LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f);
        layoutParams1.setMargins(dpTpPx(5), dpTpPx(10), dpTpPx(5), dpTpPx(10));
        tab.setLayoutParams(layoutParams1);
        tab.setTextColor(textUnselectedColor);
        if (i != 0) {
            tab.setCompoundDrawablesWithIntrinsicBounds(null, null, getResources().getDrawable(menuUnselectedIcon), null);
        }
        tab.setBackgroundResource(R.drawable.dropmeun_selector);
        tab.setText(tabTexts.get(i));
        tab.setPadding(dpTpPx(5), dpTpPx(5), dpTpPx(12), dpTpPx(5));
        //添加点击事件
    ...
    public void setTabText(String text) {
        if (current_tab_position != -1) {
            if (tabMenuView.getChildAt(current_tab_position) == null) {
                return;
            }
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            ...
            ((TextView) tabMenuView.getChildAt(current_tab_position)).setBackgroundResource(R.drawable.dropmeun_selector);
...
//                            getResources().getDrawable(menuSelectedIcon), null);
                    if (current_tab_position != 0) {
                        tabMenuView.getChildAt(i).setBackgroundResource(R.mipmap.meuntab_pressed_icon);
                    }
                }
            } else {
                //设置其他未点击tab的状态
                ...
                if (i != 0) {
                    ((TextView) tabMenuView.getChildAt(i)).setCompoundDrawablesWithIntrinsicBounds(null, null,
                            getResources().getDrawable(menuUnselectedIcon), null);
                    tabMenuView.getChildAt(i).setBackgroundResource(R.drawable.dropmeun_selector);
                }
