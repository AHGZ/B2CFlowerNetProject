...
//            bitmapDescriptor = mLruCache.get(mRegionItem.getType());
//            if (bitmapDescriptor == null) {
                TextView textView = new TextView(mContext);
                textView.setGravity(Gravity.CENTER);
                textView.setTextColor(Color.BLACK);
                textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
                if (mRegionItem.getType() == 11) {//会员
                    textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.icon_hy_dw));
                }else if(mRegionItem.getType() == 12){//代理人
                    textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.icon_dlr_dw));
                }else if(mRegionItem.getType() == 13){//供货商
                    textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.icon_ghs_dw));
                }else if(mRegionItem.getType() == 14){//商家
                    textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.icon_sj_dw));
                }else if(mRegionItem.getType() == 15){//合伙人
                    textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.icon_hhr_dw));
                }else if(mRegionItem.getType() == 16){//云工
                    textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.icon_yg_dw));
                }else{
                    textView.setBackgroundDrawable(mClusterRender.getDrawAble(cluster));
                }
                bitmapDescriptor = BitmapDescriptorFactory.fromView(textView);
                mLruCache.put(mRegionItem.getType(), bitmapDescriptor);
//            }

        }
//        BitmapDescriptor bitmapDescriptor = mLruCache.get(cluster.getClusterCount());
//        if (bitmapDescriptor == null) {
//            TextView textView = new TextView(mContext);
//            if (cluster.getClusterCount() > 1) {
//                String tile = String.valueOf(cluster.getClusterCount());
...
//                        textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.icon_dlr_dw));
//                    }else if(regionItem.getType() == 3){
//                        textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.icon_ghs_dw));
//                    }else if(regionItem.getType() == 4){
//                        textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.icon_sj_dw));
//                    }else if(regionItem.getType() == 5){
//                        textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.icon_hhr_dw));
//                    }else if(regionItem.getType() == 6){
//                        textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.icon_yg_dw));
//                    }else{
//                        textView.setBackgroundDrawable(mClusterRender.getDrawAble(cluster));
//                    }
