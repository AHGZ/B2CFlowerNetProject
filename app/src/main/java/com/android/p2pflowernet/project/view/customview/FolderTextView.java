...
/**
 * Created by caishen on 2017/4/12.
 * 自定义“查看更多”的textview
 */
...
public class FolderTextView extends TextView {
    ...
    // 默认展开文字
    private static final String DEFAULT_UNFOLD_TEXT = "[了解更多]";
    // 默认固定行数
    private static final int DEFAULT_FOLD_LINE = 1;
    // 默认收起和展开文字颜色
    private static final int DEFAULT_TAIL_TEXT_COLOR = Color.parseColor("#4B4B4B");
    // 默认是否可以再次收起
    ...
    private String tailorText(String text) {
        // return_ticket tailorTextBackUp(text);
