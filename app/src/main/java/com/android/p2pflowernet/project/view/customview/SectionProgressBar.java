...
public class SectionProgressBar extends View {
    ...
    public SectionProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLevelValues = context.getResources().getIntArray(R.array.PartnerSectionLevelValues);
        ...
        mBarHeight = ta.getDimension(R.styleable.SectionProgressBar_section_bar_height, dp2px(8));
...
//        canvas.drawRoundRect(rectF, mBarHeight / 2.f, mBarHeight / 2.f, mBackgroundPaint);//画圆角矩形
    }
    ...
    private void drawForeground(Canvas canvas) {
        ...
        rectF.bottom = getHeight() / 3.f + mBarHeight / 2.f;
//        canvas.drawRoundRect(rectF, mBarHeight / 2.f, mBarHeight / 2.f, mForegroundPaint);//画圆角矩形
        canvas.drawRect(rectF, mForegroundPaint);
