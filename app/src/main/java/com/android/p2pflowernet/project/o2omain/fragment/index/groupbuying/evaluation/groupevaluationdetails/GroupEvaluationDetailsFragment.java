...
public class GroupEvaluationDetailsFragment extends KFragment<IGroupEvaluationDetailsView, IGroupEvaluationDetailsPresenter> implements IGroupEvaluationDetailsView {
    ...
    public static GroupEvaluationDetailsFragment newInstance() {
        Bundle args = new Bundle();
        GroupEvaluationDetailsFragment fragment = new GroupEvaluationDetailsFragment();
    ...
    protected void init(@Nullable View view, @Nullable Bundle savedInstanceState) {
        ...
        shapeLoadingDialog = new ShapeLoadingDialog.Builder(getActivity())
                ...
                .loadText("加载中...")
                .build();
            mPresenter.getShopEvaluation(1,5,0,1);
    }
