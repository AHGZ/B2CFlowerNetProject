...
package com.android.p2pflowernet.project.utils.clusterutil.clustering.view;
...
import com.android.p2pflowernet.project.utils.clusterutil.MarkerManager;
import com.android.p2pflowernet.project.utils.clusterutil.clustering.Cluster;
import com.android.p2pflowernet.project.utils.clusterutil.clustering.ClusterItem;
import com.android.p2pflowernet.project.utils.clusterutil.clustering.ClusterManager;
import com.android.p2pflowernet.project.utils.clusterutil.projection.Point;
import com.android.p2pflowernet.project.utils.clusterutil.projection.SphericalMercatorProjection;
import com.android.p2pflowernet.project.utils.clusterutil.ui.IconGenerator;
import com.android.p2pflowernet.project.utils.clusterutil.ui.SquareTextView;
...
import static com.android.p2pflowernet.project.utils.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    /**
     * Markers that are currently on the activity_course_order_layout.
     */
     ...
     * <p/>
     * 1. Markers are added to the activity_course_order_layout
     * <p/>
     * 2. Markers are animated to their final position
     * <p/>
     * 3. Any old markers are removed from the activity_course_order_layout
     * <p/>
    ...
    /**
     * Handles all markerWithPosition manipulations on the activity_course_order_layout. Work (such as adding, removing, or
    ...
    /**
     * Called before the marker for a ClusterItem is added to the activity_course_order_layout.
     */
    protected void onBeforeClusterItemRendered(T item, MarkerOptions markerOptions) {
    }

    /**
     * Called before the marker for a Cluster is added to the activity_course_order_layout.
    ...
    /**
     * Called after the marker for a Cluster has been added to the activity_course_order_layout.
     */
    protected void onClusterRendered(Cluster<T> cluster, Marker marker) {
    }

    /**
     * Called after the marker for a ClusterItem has been added to the activity_course_order_layout.
     */
