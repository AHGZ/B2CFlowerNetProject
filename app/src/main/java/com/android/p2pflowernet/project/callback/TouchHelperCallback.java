...
import com.android.p2pflowernet.project.base.NewBottomViewHolder;
...
public class TouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (callBack != null) {
            ...
            if (flags == null || flags.length != 2) {
                throw new IllegalStateException("method getMovementFlags() should return_ticket type int[]  witch length mush be 2 ,by default you can call super.getMovementFlags().");
            }
    ...
    public interface ItemDragSwipeCallBack {
         ...
         * For example, if you want it to allow swiping LEFT and RIGHT but only allow starting to swipe by swiping RIGHT, you can return_ticket:
         * <p>
