...
public class SpaceItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public SpaceItemDecoration(Context context, int dividerHight, int dividerColor) {
        this(context);
     ...
     */
    public SpaceItemDecoration(Context context, int dividerHight, Drawable dividerDrawable) {
        this(context);
        mDividerHight = dividerHight;
