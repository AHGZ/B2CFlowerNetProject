...
class GroupShopDetailListAdapter extends BaseAdapter {

    private List<GroupFullDetailBean.GroupBean.GoodsListBean> goodsList;

    public GroupShopDetailListAdapter(List<GroupFullDetailBean.GroupBean.GoodsListBean> goodsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(parent.getContext(), R.layout.group_buying_shopdetails_item_data, null);
