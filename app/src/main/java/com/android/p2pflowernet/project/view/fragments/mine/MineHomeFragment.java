 ...
 * @描述:
 * @创建人：zhangpeisen
 * @创建时间：2017/10/24 下午1:56
 * @修改人：zhangpeisen
 * @修改时间：2017/10/24 下午1:56
 * @修改备注： 我的模块
 * @throws
 */
public class MineHomeFragment extends KFragment<IMineView, IMinePresenter> implements IMineView {
    ...
    protected int getLayout() {
        ...
        return R.layout.minehome_fragment;
    }
...
//        //初始化申请合伙人资质的弹窗
//        showAlertMsgDialog("您有新的申请订单，请尽快处理。由于您的花返平台账户余额不足，系统无法自动审核，请及时购买合伙人资质",
//                "温馨提示", "购买审批资质", "取消");
    }
...
//            circleImageView.setBackgroundResource(R.mipmap.default_header);
    ...
    public void onEvent(UserInfoEvent userInfoEvent) {
        ...
        if (userInfoEvent.getUserInfo() == null) {
            ...
            minesurrogate_im.setImageResource(R.drawable.icon_agentdefault);
            minepartner_im.setImageResource(R.drawable.icon_partnerdefault);
            minecloudworker_im.setImageResource(R.drawable.icon_clouddefault);
            store_im.setImageResource(R.drawable.icon_icon_businessdefault);
            rl_pendingpayment.setText("0");
            rl_pendingshipment.setText("0");
            rl_person_send.setText("0");
            rl_pendingcomment.setText("0");
            rl_person_aftermarket.setText("0");
            isLogin = "";
    ...
    public void setMineMyInfo(MineMyBean mineMyBean) {
        ...
        if (is_agent.equals("1")) {
            // 是
            minesurrogate_im.setImageResource(R.drawable.icon_agentcurrent);
        } else {
            minesurrogate_im.setImageResource(R.drawable.icon_agentdefault);
        }
        ...
        if (is_partner.equals("1")) {
            // 是
            minepartner_im.setImageResource(R.drawable.icon_partnercurrent);
        } else {
            minepartner_im.setImageResource(R.drawable.icon_partnerdefault);
        } //
        ...
        if (is_staff.equals("1")) {
            // 是
            minecloudworker_im.setImageResource(R.drawable.icon_cloudcurrent);
        } else {
            minecloudworker_im.setImageResource(R.drawable.icon_clouddefault);
        }
        ...
        if (is_merchant.equals("1")) {
            // 是
            store_im.setImageResource(R.drawable.icon_businesscurrent);
        } else {
            store_im.setImageResource(R.drawable.icon_icon_businessdefault);
        }
        ...
        // 是否供应商
        if (is_manufac.equals("1")) {
            // 是
            supplierIv.setImageResource(R.drawable.icon_suppliercurrent);
        } else {
            supplierIv.setImageResource(R.drawable.icon_supplierdefault);
        }
    ...
    @OnClick({R.id.user_headerimg,
            R.id.iv_setup, R.id.iv_message, R.id.apply_btn, R.id.mywallet_ly, R.id.myteam_ly
            , R.id.allorder_ly, R.id.rl_pendingpayment, R.id.rl_pendingshipment, R.id.rl_person_send, R.id.rl_pendingcomment
            , R.id.rl_person_aftermarket, R.id.share_ly, R.id.nickName, R.id.iv_present, R.id.ll_wmdd,
            R.id.ll_tgdd, R.id.ll_share, R.id.ll_lecture})
...
//        showShortToast(s);
    ...
    public void onCardSuccess(BankInfoBean data, String message) {
        ...
        if (data != null) {
            ...
            if (list != null && list.size() > 0) {//绑定过银行卡
