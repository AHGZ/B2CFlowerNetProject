...
public class VerticalStepViewIndicator extends View {
    ...
    private void init() {
        ...
        mCompleteIcon = ContextCompat.getDrawable(getContext(), R.drawable.icon_passed);//已经完成的icon
        mAttentionIcon = ContextCompat.getDrawable(getContext(), R.drawable.attention);//正在进行的icon
        mDefaultIcon = ContextCompat.getDrawable(getContext(), R.drawable.icon_now);//未完成的icon
