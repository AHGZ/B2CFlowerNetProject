...
public class ShoppingKnowAdapter extends BaseAdapter {

    private List<GroupFullDetailBean.GroupBean.NoticeBean> notice;

    public ShoppingKnowAdapter(List<GroupFullDetailBean.GroupBean.NoticeBean> notice) {
        this.notice = notice;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(parent.getContext(), R.layout.group_goshopping_know_item, null);
