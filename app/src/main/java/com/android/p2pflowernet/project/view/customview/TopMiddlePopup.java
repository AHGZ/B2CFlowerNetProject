...
import com.android.p2pflowernet.project.adapter.PopupAdapter;

import java.util.ArrayList;

/**
 * Created by caishen on 2017/10/24.
 * by--自定义顶部弹窗
 */
...
public class TopMiddlePopup extends PopupWindow {
    ...
    public TopMiddlePopup(Context context, int width, int height,
                          AdapterView.OnItemClickListener onItemClickListener, ArrayList<String> items, int type) {
