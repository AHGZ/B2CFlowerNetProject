...
import com.android.p2pflowernet.project.view.fragments.forum.textdetails.ITextDetailsModel;
...
public class IVideoDetailsPresenter extends IPresenter<IVideoDetailsView> {

    ITextDetailsModel iTextDetailsModel;

    public IVideoDetailsPresenter() {
