package com.android.p2pflowernet.project.push;
...
import com.android.p2pflowernet.project.utils.PushUtils;
...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onNotificationArrived(Context context, String title,
        ...
        EventBus.getDefault().post(new PushMsgEvent(title, description));
