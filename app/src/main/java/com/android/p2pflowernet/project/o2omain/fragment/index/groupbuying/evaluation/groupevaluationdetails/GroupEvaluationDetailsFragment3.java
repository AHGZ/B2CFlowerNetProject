...
public class GroupEvaluationDetailsFragment3 extends KFragment<IGroupEvaluationDetailsView, IGroupEvaluationDetailsPresenter> implements IGroupEvaluationDetailsView {
    ...
    public static GroupEvaluationDetailsFragment3 newInstance() {
        Bundle args = new Bundle();
        GroupEvaluationDetailsFragment3 fragment = new GroupEvaluationDetailsFragment3();
    ...
    protected void init(@Nullable View view, @Nullable Bundle savedInstanceState) {
        shapeLoadingDialog = new ShapeLoadingDialog.Builder(getActivity())
                ...
                .loadText("加载中...")
                .build();
            mPresenter.getShopEvaluation(1,5,1,1);
