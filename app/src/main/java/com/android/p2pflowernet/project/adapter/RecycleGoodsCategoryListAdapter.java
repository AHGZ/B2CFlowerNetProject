 ...
 * @描述: 店铺详情
 * @创建人：zhangpeisen
 * @创建时间：2018/1/10 下午2:03
 * @修改人：zhangpeisen
 * @修改时间：2018/1/10 下午2:03
 * @修改备注：
 * @throws
 */
public class RecycleGoodsCategoryListAdapter extends RecyclerView.Adapter<RecycleGoodsCategoryListAdapter.ViewHolder> {
    ...
    private List<O2oIndexBean.ListsBean> dataList;
    public Context mContext;

    public RecycleGoodsCategoryListAdapter(List<O2oIndexBean.ListsBean> dataList, Context context) {
        this.dataList = dataList;
        this.mContext = context;
    }

    public void changeData(List<O2oIndexBean.ListsBean> dataList) {
        this.dataList = dataList;
    ...
    public void onBindViewHolder(RecycleGoodsCategoryListAdapter.ViewHolder holder, final int position) {
        ...
        holder.shopCartNum.setText(dataList.get(position).getNum());
        String num = dataList.get(position).getNum();
