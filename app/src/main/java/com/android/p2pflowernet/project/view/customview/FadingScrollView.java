...
public class FadingScrollView extends ScrollView {
    ...
    private int oldY; //滑动距离，默认设置滑动500 时完全显示，
    // 根据实际需求自己设置
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (fadingHeightView != null) fadingHeight = fadingHeightView.getMeasuredHeight();
    }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        // l,t 滑动后 xy位置，
        // oldl lodt 滑动前 xy 位置-----
        float fading = t > fadingHeight ? fadingHeight : (t > 48 ? t : 0);
